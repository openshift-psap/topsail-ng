"""Prefix precise routing - EPP with prefix-cache-scorer."""
...
class PrefixPreciseRouting(RoutingStrategy):
    """
    Prefix precise routing mode.

    Uses EPP with prefix-cache-scorer for hash-based
    precise prefix matching.
    """
    ...
    def get_router_config(self, experiment: Experiment) -> str:
        """EPP router config with prefix-cache-scorer."""
        return f"""router:
    scheduler:
      template:
        containers:
